...
<div>
	...
	<?php
	echo $this->Html->link($this->Html->image('/acl/img/design/cross.png') . ' ' . __d('acl', 'Clear permissions table'), '/acl/aros/empty_permissions', array('confirm' => __d('acl', 'Are you sure you want to delete all roles and users permissions ?'), 'escape' => false));
	?>
...
<div>
	...
	<table cellpadding="5" cellspacing="2" class="table table-bordered table-highlight-head">
	<thead>
		<tr>
    	<?php
