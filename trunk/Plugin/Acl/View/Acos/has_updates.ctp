...
<div class="error">
	...
	<div class="notification information">
		<p><strong>INFORMATION: </strong><?php echo __d('acl', 'Some controllers have been modified, resulting in actions that are not referenced as ACO in the database or ACO records that are obsolete'); ?></p>
	</div>
	...
	echo $this->Html->link(__d('acl', 'Synchronize ACOs'), '/acl/acos/synchronize/run');
	echo '</p>';
