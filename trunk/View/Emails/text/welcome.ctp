...
<?php echo __('To get started simply visit');?> <?php echo $this->Html->url(array('controller' => 'users', 'action' => 'login'), true);?> <?php echo __('and use the following details to login.');?>
